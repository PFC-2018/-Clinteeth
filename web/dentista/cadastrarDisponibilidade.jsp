            ...
            <div id="page-content-wrapper">
                <div class="panel-body">
                    ...
                    <div class="page-content inset">
                        <div class="row">
                            <div class="col-md-12">
                                <p class="well lead text-center">Dados da Disponibilidade</p>
                                <div class="container">                                    
                                    <form class="form-horizontal" action="<%=request.getContextPath()%>/Disponibilidade" method="post">
                                        ...
                                        <div class="col-sm-12 contact-form"> 
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    <label class="col-xs-0 control-label"> <J1>Data Disponivel:</J1> </label>
                                                </div>
                                                <div class="col-md-12">
                                                    <j1><input class="form-check-input" type="checkbox" name="datadisponivel" value="DOMINGO" checked=""/>Domingo</j1>
                                                    <j1><input class="form-check-input" type="checkbox" name="datadisponivel" value="SEGUNDA" checked=""/>Segunda</j1>
                                                    <j1><input class="form-check-input" type="checkbox" name="datadisponivel" value="TERCA" checked=""/>Terça</j1>
                                                    <j1><input class="form-check-input" type="checkbox" name="datadisponivel" value="QUARTA" checked=""/>Quarta</j1>
                                                    <j1><input class="form-check-input" type="checkbox" name="datadisponivel" value="QUINTA" checked=""/>Quinta</j1>
                                                    <j1><input class="form-check-input" type="checkbox" name="datadisponivel" value="SEXTA" checked=""/>Sexta</j1>
                                                    <j1><input class="form-check-input" type="checkbox" name="datadisponivel" value="SABADO" checked=""/>Sábado</j1>
                                                </div>
                                            </div>
                                            <div class="form-group">                                                                                                                                                   
                                                <label class="col-xs-1 control-label"> <j1>Horario</j1> </label>                                                   
                                                <j1><input class="form-check-input" type="checkbox" name="hora" value="SETE" checked=""/>07:00</j1>
