            ...
            <div id="page-content-wrapper">
                <div class="panel-body">
                    ...
                    <div class="page-content inset">
                        <div class="row">
                            <div class="col-md-10">
                                <p class="well lead">Cadastro de Atendente</p>
                                <div class="container">                                    
                                        ...
                                        <div class="col-sm-12 contact-form"> 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <%
                                                    String verificaCPF = (String) request.getAttribute("verificaCPF");
                                                    if (verificaCPF != null) {
                                                    %>
                                                    <div class="alert alert-danger" id="verificaCPF">
                                                      <font color="red"><j1><%=verificaCPF%></j1></font>
                                                    </div>
                                                <%}%>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="tipo" id="tipo" hidden value="ATENDENTE">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <input placeholder="" class="form-control input-md" required type="text" name="senha" id="senha"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <a class="btn btn-warning btn-xs" href="<%=request.getContextPath()%>/Pessoa?btnAcionar=ListarTudo">Listar</a>
                                            </div>
                                        </div>
                                </div>
                                </form>
