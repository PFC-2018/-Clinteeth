            ...
            <div id="page-content-wrapper">
                <div class="panel-body">
                    ...
                    <div class="page-content inset">
                        <div class="row">
                            <div class="col-md-10">
                                <p class="well lead">Cadastro de Paciente</p>
                                <div class="container">                                    
                                    <form class="form-horizontal" action="<%=request.getContextPath()%>/Paciente" method="post">
                                        <div class="col-sm-12 contact-form"> 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="tipo" id="tipo" hidden value="PACIENTE">
                                                <label class="col-md-1 control-label"> <J1>Convenio</J1> </label>                    
                                                <div class="col-md-3">
                                                    <input placeholder="Convenio" class="form-control input-md" required type="text" name="convenio"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <a class="btn btn-warning btn-xs" href="<%=request.getContextPath()%>/Paciente?btnAcionar=ListarTudo">Listar</a>
                                            </div>
                                        </div>
                                </div>
                                </form>
