        ...
        <div id="wrapper" class="active">  
            ...
            <div id="page-content-wrapper">
                ...
                <div class="page-content inset">
                    <div class="row">
                        <div class="col-md-12">
                            <p class="well lead">Lista de Pacientes</p>
                            <div class="container">
                                <div class="row"> 
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-3">
                                        <a href="<%=request.getContextPath()%>/atendente/cadastrarPaciente.jsp" class="btn btn-primary pull-right h2">Novo Paciente</a>
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-hover table-striped" cellspacing="1" cellpadding="1">
                                        ...
                                        <tbody>
                                            <c:forEach items="${paciente}" var="p">
                                                <tr>
                                                    <!--<td> ${p.pacienteID} </td>
                                                    <td> ${p.pessoa.pessoaID} </td>-->
                                                    <td><j1> ${p.pessoa.nome} </j1></td>
                                                    <td><j1> ${p.convenio} </j1></td>
                                              <!--  <td> ${p.rg} </td>
                                                    <td> ${p.cpf} </td>
                                                    
                                                    <td> <fmt:formatDate value="${p.dataNascimento}" pattern="dd/MM/yyyy" /> </td> -->
                                                    <td><j1> ${p.pessoa.telefone} </j1></td>
                                                    <td><j1> ${p.pessoa.celular} </j1></td>
                                                    <td><j1> ${p.pessoa.login.email} </j1></td>
                                               <!-- <td> ${p.endereco.logradouro} </td>
                                                    ...
                                                    <td> ${p.endereco.uf} </td> -->
                                                    <td class = "actions">
                                                        <a class="btn btn-success btn-xs" href="<%=request.getContextPath()%>/Paciente?btnAcionar=ListarPorID&id=${p.pessoa.pessoaID}">Visualizar</a>
                                                    </td>                        
                                                </tr>
                                            </c:forEach>
                                        </tbody>
